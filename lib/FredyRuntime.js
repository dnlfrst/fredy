...
class FredyRuntime {
   ...
   * @param providerName the name of the provider currently in use
   ...
   */
  constructor(providerConfig, notificationConfig, providerId, providerName, jobKey, similarityCache) {
  ...
  _notify(newListings) {
    ...
    const sendNotifications = notify.send(this._providerName, newListings, this._notificationConfig, this._jobKey);
